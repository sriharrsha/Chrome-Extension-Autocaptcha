...
},{"../../package.json":4,"_process":1}],6:[function(require,module,exports){
...
},{"../node/index.js":5}],8:[function(require,module,exports){
const adapter = require('./node/index.js')
...
module.exports = DefaultTesseract
},{"../package.json":4,"./common/circularize.js":6,"./common/job":7,"./node/index.js":5,"object-assign":3}],9:[function(require,module,exports){
    var Tesseract = require('tesseract.js');
    var $ = require("jquery");

    function test(){
    var  enterCaptcha=document.getElementById("txtverifycode");
    var img=enterCaptcha.nextElementSibling;
    Tesseract.recognize(img, {
    lang: 'eng',
    tessedit_char_blacklist: "!@#$%^&*(){}[]|\/\\`~.,?;:'\"<>ABCDEFGHIJKLMNOPQURSTUVWXYZ"
    }).then(function(result){
    console.log(result)
    enterCaptcha.value = result.text;
    })
    }
    function myTimer(){
      var  enterCaptcha=document.getElementById("txtverifycode");
    ...
    if (site.includes("evarsity.srmuniv.ac.in/srmswi/usermanager/youLogin.jsp")){
      var myVar = setInterval(myTimer, 500);
    }



},{"jquery":2,"tesseract.js":8}]},{},[9]);
