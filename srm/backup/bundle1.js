...
},{"../../package.json":3,"_process":1}],5:[function(require,module,exports){
...
module.exports = DefaultTesseract
},{"../package.json":3,"./common/circularize.js":5,"./common/job":6,"./node/index.js":4,"object-assign":2}],8:[function(require,module,exports){
    var Tesseract = require('tesseract.js')
    var  enterCaptcha=document.getElementById("txtverifycode");
    var img=enterCaptcha.nextElementSibling;
    if(enterCaptcha==null){
      alert("No sib");
    }
    if(img==null){
      alert("No image");
    ...
    console.log(result)
    enterCaptcha.innerText = result.text;
    })
},{"tesseract.js":7}]},{},[8]);
